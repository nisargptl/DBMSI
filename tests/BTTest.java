...
class BTDriver  implements GlobalConst
{
 ...
 private void menu() {
  ...
  System.out.println("Total page reads:"+PCounter.rcounter+", Total page writes:"+PCounter.wcounter);
    System.out.println("Total page reads:"+PCounter.rcounter+", Total page writes:"+PCounter.wcounter);
	  break;            
	case 1:

  PCounter.initialize();  postfix++; 
	  deleteFashion=1; //full delete
	  System.out.println(" ***************** The file name is: "+ "AAA"+postfix +"  **********"); 
  ...
  PCounter.initialize();  BT.printBTree(file.getHeaderPage()); 
      System.out.println("Total page reads:"+PCounter.rcounter+", Total page writes:"+PCounter.wcounter);
	  break;          
	case 3:

  PCounter.initialize();  BT.printAllLeafPages(file.getHeaderPage());
      System.out.println("Total page reads:"+PCounter.rcounter+", Total page writes:"+PCounter.wcounter);
	  break;            
	case 4:

  PCounter.initialize();  System.out.println("Please input the page number: ");              
  ...
  PCounter.initialize();  keyType=AttrType.attrInteger;
  ...
  PCounter.initialize();  file.close();
	  postfix++;
	  keyType=AttrType.attrInteger;
